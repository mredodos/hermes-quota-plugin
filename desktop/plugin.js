...
const PROVIDER_SVGS = {
	...
	copilot: {
		...
		// used to carry (the two are different products). fill-rule stays on the
		// path: the second subpath is the inner cut-out and would fill in under
		// nonzero, because the wrapping <svg> sets no rule.
		viewBox: "0 0 24 24",
		body: '<path fill-rule="evenodd" d="M9 23l.073-.001a2.53 2.53 0 01-2.347-1.838l-.697-2.433a2.529 2.529 0 00-2.426-1.839h-.497l-.104-.002c-4.485 0-2.935-5.278-1.75-9.225l.162-.525C2.412 3.99 3.883 1 6.25 1h8.86c1.12 0 2.106.745 2.422 1.829l.715 2.453a2.53 2.53 0 002.247 1.823l.147.005.534.001c3.557.115 3.088 3.745 2.156 7.206l-.113.413c-.154.548-.315 1.089-.47 1.607l-.163.525C21.588 20.01 20.116 23 17.75 23h-8.75zm8.22-15.89l-3.856.001a2.526 2.526 0 00-2.35 1.615L9.21 15.04a2.529 2.529 0 01-2.43 1.847l3.853.002c1.056 0 1.992-.661 2.361-1.644l1.796-6.287a2.529 2.529 0 012.43-1.848z"></path>',
	},
	nous: {
		viewBox: "0 0 24 24",
	...
	// Stylized Z traced from the maintainer-supplied Z.ai reference logo:
	// top bar, thick diagonal, bottom bar — three parallelograms whose end
	// cuts run parallel to the diagonal. Original geometry (not extracted
	// from @lobehub/icons); inline path data only, no external asset.
	zai: {
		viewBox: "0 0 24 24",
